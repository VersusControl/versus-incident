...
func (fr FindRunbook) Invoke(ctx context.Context, args json.RawMessage) (*core.ToolResult, error) {
	if fr.Embedder == nil || fr.Index == nil {
		...
		return core.UnavailableToolResult(FindRunbook{}.Name(), "AI embedder and runbook index not configured"), nil
	}
	...
	matches, err := fr.Index.Search(ctx, vecs[0], a.Service, a.Limit+1)
	if err != nil {
