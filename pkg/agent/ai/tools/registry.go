...
var toolsets = []ToolsetMetadata{
	...
	{ID: "logs", Section: SectionDataSource, DisplayName: "Logs", Description: "Read bounded redacted logs related to a concrete service and time window.", IconKey: "logs", ToolNames: []string{"get_related_logs", "discover_log_fields", "read_log_records"}, Requirement: Requirement{Kind: RequirementDataSource, SignalKind: "logs"}, DocsURL: "https://docs.versusincident.com/#/agent/data-sources", UIPath: "/agent/logs", Visibility: VisibilityAlways},
	{ID: "elasticsearch-logs", Section: SectionDataSource, DisplayName: "Elasticsearch", Description: "Discover mappings and shard health, and search bounded data in configured log indices.", IconKey: "elasticsearch", ToolNames: []string{"list_log_indices", "get_log_mappings", "search_logs", "get_log_shards"}, Requirement: Requirement{Kind: RequirementDataSource, SignalKind: "elasticsearch"}, DocsURL: "https://docs.versusincident.com/#/agent/data-sources", UIPath: "/agent/logs", Visibility: VisibilityAlways, Permission: core.PermissionInfrastructureView},
	...
	{ID: "traces", Section: SectionDataSource, DisplayName: "Traces", Description: "Inspect bounded distributed traces for a concrete service and time window.", IconKey: "traces", ToolNames: []string{"query_traces", "discover_trace_fields", "read_trace_spans"}, Requirement: Requirement{Kind: RequirementDataSource, SignalKind: "traces"}, DocsURL: "https://docs.versusincident.com/#/agent/data-sources/traces", UIPath: "/agent/traces", Visibility: VisibilityAlways},
	...
	{ID: "describe_baseline", Section: SectionCommon, DisplayName: "Describe baseline", Description: "Inspect bounded learned expectations for a service signal.", IconKey: "activity", ToolNames: []string{"describe_baseline"}, Requirement: Requirement{Kind: RequirementCapability, Capabilities: []string{"baseline_provider"}}, DocsURL: docsTools + "?id=describe_baseline", Visibility: VisibilityAlways, Permission: core.PermissionInfrastructureView},
}
...
var catalog = []Metadata{
	...
	{Group: GroupCommon, Name: "discover_log_fields", DisplayName: "Discover log fields", Description: "Discover bounded source-wide fields on an unscoped configured log source.", DocsURL: "https://docs.versusincident.com/#/agent/data-sources/signoz", UIPath: "/agent/logs", Requirement: Requirement{Kind: RequirementDataSource, SignalKind: "logs", Capabilities: []string{"discover_log_fields"}}},
	{Group: GroupCommon, Name: "read_log_records", DisplayName: "Read log records", Description: "Read bounded logs using service, severity, text, and time filters.", DocsURL: "https://docs.versusincident.com/#/agent/data-sources/signoz", UIPath: "/agent/logs", Requirement: Requirement{Kind: RequirementDataSource, SignalKind: "logs", Capabilities: []string{"read_log_records"}}},
	{Group: GroupCommon, Name: "list_log_indices", DisplayName: "List log indices", Description: "List bounded indices matching a configured Elasticsearch log source.", DocsURL: "https://docs.versusincident.com/#/agent/data-sources", UIPath: "/agent/logs", Requirement: Requirement{Kind: RequirementDataSource, SignalKind: "elasticsearch"}},
	{Group: GroupCommon, Name: "get_log_mappings", DisplayName: "Log mappings", Description: "Inspect bounded field mappings for a configured Elasticsearch log source.", DocsURL: "https://docs.versusincident.com/#/agent/data-sources", UIPath: "/agent/logs", Requirement: Requirement{Kind: RequirementDataSource, SignalKind: "elasticsearch"}},
	{Group: GroupCommon, Name: "search_logs", DisplayName: "Search logs", Description: "Search a configured Elasticsearch log source with bounded read-only Query DSL.", DocsURL: "https://docs.versusincident.com/#/agent/data-sources", UIPath: "/agent/logs", Requirement: Requirement{Kind: RequirementDataSource, SignalKind: "elasticsearch"}},
	{Group: GroupCommon, Name: "get_log_shards", DisplayName: "Log shard health", Description: "Inspect bounded shard health for a configured Elasticsearch log source.", DocsURL: "https://docs.versusincident.com/#/agent/data-sources", UIPath: "/agent/logs", Requirement: Requirement{Kind: RequirementDataSource, SignalKind: "elasticsearch"}},
	{Group: GroupCommon, Name: "query_metrics", DisplayName: "Query metrics", Description: "Summarize metric series for a concrete service and time window.", DocsURL: "https://docs.versusincident.com/#/agent/data-sources/prometheus", UIPath: "/agent/metrics", Requirement: Requirement{Kind: RequirementDataSource, SignalKind: "metrics", Capabilities: []string{"query_metrics"}}},
	{Group: GroupCommon, Name: "discover_metrics", DisplayName: "Discover metrics", Description: "Discover bounded source-wide metric metadata on an unscoped configured source.", DocsURL: "https://docs.versusincident.com/#/agent/data-sources/signoz", UIPath: "/agent/metrics", Requirement: Requirement{Kind: RequirementDataSource, SignalKind: "metrics", Capabilities: []string{"discover_metrics"}}},
	{Group: GroupCommon, Name: "read_metric_series", DisplayName: "Read metric series", Description: "Read one bounded metric series for a service and time window.", DocsURL: "https://docs.versusincident.com/#/agent/data-sources/signoz", UIPath: "/agent/metrics", Requirement: Requirement{Kind: RequirementDataSource, SignalKind: "metrics", Capabilities: []string{"read_metric_series"}}},
	{Group: GroupCommon, Name: "query_traces", DisplayName: "Query traces", Description: "Inspect bounded distributed traces for a concrete service and time window.", DocsURL: "https://docs.versusincident.com/#/agent/data-sources/traces", UIPath: "/agent/traces", Requirement: Requirement{Kind: RequirementDataSource, SignalKind: "traces", Capabilities: []string{"query_traces"}}},
	{Group: GroupCommon, Name: "discover_trace_fields", DisplayName: "Discover trace fields", Description: "Discover bounded source-wide fields on an unscoped configured trace source.", DocsURL: "https://docs.versusincident.com/#/agent/data-sources/signoz", UIPath: "/agent/traces", Requirement: Requirement{Kind: RequirementDataSource, SignalKind: "traces", Capabilities: []string{"discover_trace_fields"}}},
	{Group: GroupCommon, Name: "read_trace_spans", DisplayName: "Read trace spans", Description: "Read bounded spans using service, operation, error, and time filters.", DocsURL: "https://docs.versusincident.com/#/agent/data-sources/signoz", UIPath: "/agent/traces", Requirement: Requirement{Kind: RequirementDataSource, SignalKind: "traces", Capabilities: []string{"read_trace_spans"}}},
	...
	{Group: GroupCommon, Name: "describe_baseline", DisplayName: "Describe baseline", Description: "Inspect bounded learned expectations for one service and signal.", DocsURL: docsTools + "?id=describe_baseline", Requirement: Requirement{Kind: RequirementCapability, Capabilities: []string{"baseline_provider"}}},
